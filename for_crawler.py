...
Original file is located at
    https://colab.research.google.com/drive/1bfzK5OdPCvCzuRabbCn3AXboUGSMnYz2
"""
...
# 2. 安裝 webdriver-manager (管理 chrome driver 版本)
...
df_check= pd.read_csv('/content/today_veg_prices.csv')
#df = df.drop(columns=['Unnamed: 0'])
df_check

df1 = pd.read_csv('/content/drive/MyDrive/比賽/veg_prices_history.csv')
df1
...
df_merged.to_csv('/content/drive/MyDrive/比賽/veg_prices_history.csv', index=False)

print("合併後的資料已存回 veg_prices_history.csv")

df_cheeckmore = pd.read_csv('/content/drive/MyDrive/比賽/veg_prices_history.csv')
len(df_cheeckmore)
