...
Original file is located at
    https://colab.research.google.com/drive/1PDworXnRiS5Gr1H-1s_GPRcMrsMS10Yd
"""
...
df = pd.read_csv('/content/drive/MyDrive/比賽/veg_prices_history.csv')
...
result_df.to_csv("/content/drive/MyDrive/比賽/veg_pred.csv", index=False, encoding="utf-8-sig")

print("✅ 已完成，輸出veg_pred.csv")

check = pd.read_csv('/content/drive/MyDrive/比賽/veg_pred.csv')
check
